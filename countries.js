...
chang_country_btn.addEventListener("click", function () {
	input.value = "";
	resetCountryList();
	search_country_element.classList.toggle("dis");
...
input.addEventListener("input", function () {
	...
	country_list.forEach((country) => {
		if (country.name.toUpperCase().startsWith(value)) {
			document.getElementById(country.name).classList.remove("dis");
		} else {
			document.getElementById(country.name).classList.add("dis");
		}
	});
});
